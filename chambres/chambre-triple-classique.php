...
<head>
    ...
    <section id="section-1">
            ...
            <div class="container">
                <h1> Chambre Triple Classique</h1>
               <div class="left">
                <img src="./chambres/chambre-triple-classique.jpg" alt="chambre-triple-classique" height="300" width="650">
               </div> 
               <div class="midle">
...
class="close" title="Close Modal">&times;</span>
  ...
  <form method="POST" class="modal-content animate" action="">
    ...
    <div class="container">
      ...
      <label for="name"><b>Ecrivez le nom de la chambre : Chambre Triple Classique </b>  </label>
      ...
      <br><br>
      <label for="psw"><b>Prix d'une nuit : 200e</b>  </label>
      <br><br>
