...
<head>
    ...
    <section id="section-1">
            ...
            <div class="container">
               ...
               <div class="left">
                <img src="./chambres/chambre-double-confort.jpg" alt="chambre-double-confort" height="300" width="650">
               </div> 
               <div class="midle">
...
class="close" title="Close Modal">&times;</span>
  ...
  <form method="POST" class="modal-content animate" action="">
    ...
    <div class="container">
      ...
      <label for="name"><b>Ecrivez le nom de la chambre : ('Chambre Double Confort') </b>  </label>
      ...
      <br><br>
      <label for="psw"><b>Prix d'une nuit : 170e</b>  </label>
      <br><br>
