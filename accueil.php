...
<body>
    ...
    <br>
        ...
        <div class="tourisme-description">
            <div class="texte-tourisme">
                <u><h2>Ce qu'il faut voir à Carnon:</h2></u>
                <h3>Vous ne savez pas quoi faire à Carnon?</h3>
                <h3>Voici quelques lieux emblématiques que vous pouvez visiter:</h3>
                <ol type="1">
                    <li>La plage du Petit travers</li>
                    <li>Eglise Saint Jean du Malte</li>
                    <li>Le Port de Carnon</li>
                    <li>...</li>
                </ol>
